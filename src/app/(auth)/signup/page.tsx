    ...
    <section className="py-24 pt-40 bg-[#0b111e] relative w-full flex items-center justify-center">
      ...
      >
        <div className="text-center mb-8">
          <h2 className="text-3xl font-black text-white">Join LearnTech</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {isLoading ? "Processing..." : "Claim Space"}
          </button>
        </form>
        ...
        <p className="text-center text-slate-400 text-xs mt-6">
          ...
          <a href="/login" className="text-[#00ffcc] font-bold hover:underline">
            Login
          </a>
        </p>
      </motion.div>
